...
/**
 * An interface containing standardized methods for page creation.
 * 
...
public interface Page {
	...
	int tableCellHeight = 20;
	int fieldMargin = 10;
	int searchBarHeight = 30;
	int searchBarSpacing = 5;
	String defaultDateText = "mm/dd/yyyy";
	...
	default public JPanel buildPercentageBar(double value) {
		...
		positivePercentage.setBackground(Theme.textSecondaryColor);
